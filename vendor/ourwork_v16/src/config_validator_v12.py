...
ALLOWED_TOP={'slots','slot_groups','slot_options','structures','geometry','meta'}
...
def lint_config(template_id:str, config:Dict[str,Any]) -> Dict[str,Any]:
    ...
    # structure capacity / density advice
    ...
    # long text heuristic using reference raw box + font size
