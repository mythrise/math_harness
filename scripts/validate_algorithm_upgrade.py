...
def main():
    ...
    p.add_argument('--image',default='cumcm-egoharness:0.5.0-rc3')
    p.add_argument('--test-image',default='cumcm-egoharness:0.5.0-rc3-test')
    p.add_argument('--seeds',type=int,default=12)
    p.add_argument('--seed-start',type=int,default=201)
    ...
    for name in ('cumcm_harness','tests','vendor','configs','schemas','examples','templates','third_party','.agents','docs','scripts'):
